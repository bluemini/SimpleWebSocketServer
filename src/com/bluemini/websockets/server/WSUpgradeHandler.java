...
public class WSUpgradeHandler implements HttpConstants {
	 ...
	 */
	public static byte[] hashString(String toHash) throws NoSuchAlgorithmException, UnsupportedEncodingException {
